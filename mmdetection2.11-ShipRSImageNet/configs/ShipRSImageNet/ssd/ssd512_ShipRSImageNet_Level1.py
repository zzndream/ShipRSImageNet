_base_ = [
    '../_base_/models/ssd300.py', '../_base_/datasets/ShipRSImageNet_Level1_detection.py',
...
# dataset settings
dataset_type = 'ShipRSImageNet_Level1'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'COCO_Format/ShipRSImageNet_bbox_train_level_1.json',
